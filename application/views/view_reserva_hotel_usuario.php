...
<body>
	...
	<div id="contenido" style="background-image: url('https://www.turijobs.com/blog/wp-content/uploads/2018/08/recepcion-hoteles.jpg'); background-repeat: no-repeat;background-attachment: fixed;  background-size: cover;">
			...
			<div class="row align-items-center">
				<div class="col-sm-5" style="background-image: url('https://www.milideas.net/wp-content/uploads/color-hueso-titan.jpg');">
					<div class="ms-form-group" style="color:black" ;>
						<br>
						<h1><?php print_r($datos_hotel[0]->hotelNombre); ?></h1>
						<br>
						<h5>Precio por noche: $<?php print_r($datos_hotel[0]->hotelPrecioN); ?></h5>
						<br>
						<h6>Dirección: </h6>
						<?php print_r($datos_hotel[0]->hotelDireccion); ?>
						<br>
						<h6>Ciudad: </h6>
						<?php print_r($datos_hotel[0]->hotelCiudad); ?>
						<br>
						<p style="text-align: justify;"><?php print_r($datos_hotel[0]->hotelDescripcion); ?></p>
						<h6> Teléfono: </h6>
						<?php print_r($datos_hotel[0]->hotelTelefono); ?>
						<br>
					</div>
				</div>
				<div class="col-md-5">
					<div class="ms-article">
						<div class="ms-article-picture ">
							<img id="promocion1" src="https://www.lavanguardia.com/r/GODO/LV/p5/WebSite/2018/02/19/Recortada/img_azarzoso_20180219-113919_imagenes_lv_terceros_istock-165688698-khLD-U44916587013bWD-992x558@LaVanguardia-Web.jpg" />
					...
					<div class="ms-form-group">
						<form method="post">
							<h6> Fecha Ingreso</h6>
							<input type="date" name="fechaIngreso" step="1"  min="<?php echo date("Y-m-d"); ?>" style="background-color: white; color: black;">
							<h6> Fecha Salida</h6>
							<input type="date" name="fechaSalida" step="1"  min="<?php echo date("Y-m-d"); ?>" style="background-color: white; color: black;">

							<label for="nPersonas"><h6>Número de personas</h6></label>
							<select name="nPersonas" id="nPersonas" style="background-color: white; color: black;">
